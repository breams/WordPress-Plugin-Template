<?php
/**
 * This file contains the plugin custom post types.
 *
...
class WordPress_Plugin_Template_Post_Type {
	 ...
	 * @param  string $plural      Custom post type plural.
	 * @param  string $single      Custom post type single.
	 * @param  string $description Custom post type description.
